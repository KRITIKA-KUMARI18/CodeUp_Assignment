/***
 * This is the Main class of the Number Conversion and Operations File.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(constant.CommandList);
        System.out.println(constant.CommandExample);
        do {
            // To handle Null Pointer and any other Exceptions in the code
            try {
                            ...
                            if (valid.isValid(nextNumber)){
                                if ((valid.isBinaryOctalDecimal(number, base) || base == 16) && (newBase != -1)) {
                                    ...
                                    if (number1 > number2){
                                        ...
                                        System.out.println(error.InvalidDivision);
                                    }
                                } else {
                                    System.out.println(error.InvalidNumber);
                                }
